        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discriminator = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    HasBubbles = table.Column<bool>(type: "tinyint(1)", nullable: true),
                    Color = table.Column<int>(type: "int", nullable: true),
                    SugarResidues = table.Column<float>(type: "float", nullable: true),
                    Acidity = table.Column<float>(type: "float", nullable: true),
                    Tannins = table.Column<float>(type: "float", nullable: true),
                    Alcohol = table.Column<float>(type: "float", nullable: true),
                    GrapeVariety = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Region = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Vintage = table.Column<int>(type: "int", nullable: true),
                    TaxFreeUnitPrice = table.Column<float>(type: "float", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillingAdressId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Orders_Corporations_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Corporations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
